...
public class ImportRequestService {
    ...
    public ImportRequestService(IImportRequestDAO requestDAO, com.nhom18.importorder.dao.ICompanyInventoryDAO companyInventoryDAO) {
        this.requestDAO = requestDAO;
        this.companyInventoryDAO = companyInventoryDAO;
    }
